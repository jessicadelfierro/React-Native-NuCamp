//all the possible action objects that we can dispatch to reducers to let the application know the current state (when we are loading data, when we are adding data, and when our fetching of data has failed)
